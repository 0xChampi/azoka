    ...
    <div className="sticky hidden flex-grow top-0 left-0 p-2 z-20 bg-[#ff70c8] w-full shadow-2xl shadow-black font-black px-2 border-b-4 border-t-8 border-black md:flex">
      ...
      <Image src={"/logo.png"} alt={""} width={60} height={60} className="mr-[32px]"/>
        <div className="flex flexbox flex-row justify-center space-x-12 md:space-x-12 mr-6 text-[14px] md:text-[14px]">
          ...
          <Link href="#home">
            <span className="cursor-pointer hover:text-red-500">azoka</span>
          </Link>
          <Link href="#oldregalia">
            <span className="cursor-pointer hover:text-green-500">azero4</span>
          </Link>
          <Link href="#wacd">
            <span className="cursor-pointer hover:text-green-500">what is regalia</span>
          </Link>
          <Link href="#wacd">
            <span className="cursor-pointer hover:text-green-500">trans.. formers</span>
          </Link>
          {/* <Link href="#donate">
